const Testimonial = () => {
    return (
        <>
            <aside className="flex flex-col overflow-hidden items-start text-left gap-4 rounded-lg h-[222px] w-[277px] bg-white p-5 shadow-lg prose-sm lg:h-[222px] lg:w-[277px]">
                ...
                <q className="font-semibold italic leading-6">Sunny has been an outstanding contributor to our team's UI development. Highly recommended.</q>
