...
const Overview = () => {
  return (
    <div className="max-w-screen-2xl m-auto flex  px-5 flex-col gap-3 text-center  prose-xl  text-clamp lg:grid lg:grid-cols-2 lg:text-left lg:px-0">
      <div id="intro" className="flex flex-col gap-3 my-7 lg:mt-40 lg:gap-9">
        <h3 className="text-port-pink-base font-special font-medium text-base m-0 lg:text-lg hover:cursor-default">Sunny Choudhary</h3>
        ...
        <div id="action-zone" className="z-20 flex flex-col gap-5 justify-around">
          <a
      ...
      >
        ...
        <img className="rounded-full" src="sun.jpg" alt="portrait" />
